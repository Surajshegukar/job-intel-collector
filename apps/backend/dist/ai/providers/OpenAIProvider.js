...
const skillExtraction_1 = require("../prompts/skillExtraction");
const roleClassification_1 = require("../prompts/roleClassification");
const matchScoring_1 = require("../prompts/matchScoring");
const interviewPrep_1 = require("../prompts/interviewPrep");
class OpenAIProvider extends BaseProvider_1.BaseProvider {
    name = 'openai';
    async analyzeJob(options) {
...
1. Skill Extraction: ${skillExtraction_1.skillExtractionPrompt}
2. Role & Seniority Classification: ${roleClassification_1.roleClassificationPrompt}
3. Resume tailoring & Match explanation: ${matchScoring_1.matchScoringPrompt}
4. Interview Prep generation: ${interviewPrep_1.interviewPrepPrompt}
...
`;
            ...
            const missingSkills = (parsed.extractedSkills || [])
                .filter((skill) => !candidateSkillsSet.has(skill.toLowerCase().trim()));
            return {
    ...
    generateMockResult(options, startTime) {
