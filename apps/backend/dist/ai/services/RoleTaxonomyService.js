...
exports.RoleTaxonomyService = void 0;
class RoleTaxonomyService {
     ...
     */
    static classifyRole(title, description = '') {
     ...
     */
    static classifySeniority(title) {
...
exports.RoleTaxonomyService = RoleTaxonomyService;
