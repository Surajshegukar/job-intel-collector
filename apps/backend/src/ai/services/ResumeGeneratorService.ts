...
export class ResumeGeneratorService {
  static async generateTailoredResume(input: ResumeGeneratorInput): Promise<TailoredResumeOutput> {
...
`;
  ...
  private static getMockTailoredResume(input: ResumeGeneratorInput): TailoredResumeOutput {
